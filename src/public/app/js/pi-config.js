...
angular.module('piConfig', [])
  ...
  .constant('piUrls', (function () {
    ...
    // base = "http://192.168.6.68:3000/"
    
    return {
      base:                 base,
      files:                base + 'api/files/',
      storeFileInfo:        base + 'api/storeFileInfo',
      fileMapPlaylist:      base + 'api/file-map-playlist',
      ...
      piTv:                 base + 'api/piTv',
      piReboot:             base + 'api/piReboot',
      piSigusr:             base + 'api/piSigusr',
      piWifi:               base + 'api/piWifi',
      piHdmi:               base + 'api/piHdmi',

      register:             base + 'api/register',
      login:                base + 'api/login',
      logout:               base + 'api/logout',
      changePassword:       base + 'api/changePassword',
      profile:              base + 'api/profile',
      settings:             base + 'api/settings',
      licenses:             base + 'api/licenses',
      firmware:             base + 'api/firmware',
      users:                base + 'api/users',      // other
      accounts:             base + 'api/accounts',   // admin
      companies:            base + 'api/companies',
      devices:              base + 'api/devices',
      powerLogs:            base + 'api/devices/power-logs',
      streaming:            base + 'api/streaming',
      areas:                base + 'api/areas',
      oohs:                 base + 'api/ooh-positions',
      labels:               base + 'api/labels',
      histories:            base + 'api/histories',
      groups:               base + 'api/groups',
      confirms:             base + 'api/confirm-groups',
      reports:              base + 'api/reports',
      plist:                base + 'api/plist',
      uploadPlaylist:       base + 'api/uploadPlaylist',
      assets:               base + 'api/assets',
  ...
  .constant('piConstants', (function () {
    ...
    return {
      ...
      labelOptions: [
        {key: "asset", value: "assets", label: "Nhóm nội dung"},
        {key: "player", value: "players", label: "Nhóm thiết bị"}
      ],
